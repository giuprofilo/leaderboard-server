...
export function buildHtmlEmail(htmlParams: IHTMLParams): string {
	...
	!h3 ? "Verifique-se" : h3;
	!textButton ? "Clique aqui para verificar seu email" : textButton;
	!persistenceLink ? "http://localhost:4200/validation" : persistenceLink;
	!enterprise ? "Tokenlab" : enterprise;
